...
async function main() {
  const mainFactory = (await ethers.getContractFactory("AsciiArt")) as AsciiArt__factory;
  ...
  const exampleFactory = (await ethers.getContractFactory("ArtExample")) as ArtExample__factory;
